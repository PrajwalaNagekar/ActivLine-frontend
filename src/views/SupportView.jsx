  ...
  return (
    <div className="bg-slate-900 rounded-xl shadow-sm border border-slate-800 flex h-[calc(100vh-140px)] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col bg-[#0b141a] relative">
         ...
         <div className="flex-1 p-6 overflow-y-auto space-y-4 bg-[#0b141a] bg-[url('https://api.placeholder.com/assets/chat-pattern-dark.png')] bg-repeat">
         ...
         <div className="bg-slate-900 p-4 border-t border-slate-800">
            <div className="flex gap-2 mb-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-slate-700">
