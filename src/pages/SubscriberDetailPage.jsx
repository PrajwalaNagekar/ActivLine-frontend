  ...
  if (!subscriber) {
    return (
      <div className="space-y-6">
        <button onClick={() => navigate('/subscribers')} className="flex items-center text-sm text-slate-400 hover:text-white transition-colors">
          <span className="mr-1">←</span> Back to List
        </button>
        <div className="bg-slate-900 rounded-xl shadow-sm border border-slate-800 p-6">
          <p className="text-white">Subscriber not found</p>
        </div>
      </div>
    );
  }
