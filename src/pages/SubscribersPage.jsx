...
import { Search, Filter, Plus, MoreVertical, XCircle, ChevronDown } from 'lucide-react';
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-800">
              {subscribers.map((sub, i) => (
                <tr key={i} className="hover:bg-slate-800/50 group cursor-pointer transition-colors" onClick={() => handleViewDetail(sub)}>
