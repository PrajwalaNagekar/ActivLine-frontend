...
const staffNotificationsData = [
  {
    ...
    message: "Ticket #7789 - Internet Down",
  ...
  },
  {
    ...
    message: "Customer replied on #7789",
...
export default function StaffNotifications() {
  ...
  const [notifications, setNotifications] = useState(staffNotificationsData);
          ...
          <div className="flex items-center justify-between">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-sm"
              >
